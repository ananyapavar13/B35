...
public class StringExample {
	...
	public static void main(String[] args) {
        ...
        /*before any string if there is any two number or more than that
         * then it will perform addition but after any string there is any numbers
         * then it performs concatenation.
         */
        System.out.println(55+50+50+"Hello"+30+60_90);
